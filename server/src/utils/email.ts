...
export const sendResetEmail = async (email: string, code: string, name: string): Promise<boolean> => {
  try {
    const mailOptions = {
      ...
      to: email,
      subject: 'Password Reset Code - XYZ Hotel POS',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h1 style="color: #3b82f6; margin: 0;">XYZ Hotel POS</h1>
          ...
          <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
            ...
            <p style="color: #555;">You requested a password reset for your XYZ Hotel POS account.</p>
            <p style="color: #555;">Your password reset code is:</p>
            
            <div style="text-align: center; margin: 20px 0;">
              <span style="font-size: 32px; font-weight: bold; color: #3b82f6; background-color: #fff; padding: 15px 20px; border-radius: 8px; border: 2px solid #3b82f6; letter-spacing: 3px;">${code}</span>
            </div>
